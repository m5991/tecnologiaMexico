...
Con esta información podemos observar que el uso de tecnologías de información (computadora, internet, celular) existe una relación directa con el nivel de estudios. Cuando hacemos una predicción del nivel de estudios, el primer parametro a considerar es si el individuo hace uso de la computadora y sí hace uso de internet. Este parámetro no pensamos que fuera relevante entre la idea original de analizar los datos. El algoritmo de árboles de decisión encontró una buena correlación con éste y no con el usoa del internet. El internet va más allá del uso exclusivo en computadoras; actualmente se usa con teléfonos inteligentes, smart tv's, entre otras aplicaciones electrónicas en la vida cotidiana que cualquier persona hace uso de él, por tanto no fue relevante en este análisis. Esto abre la posibilida a realizar otro análisis del uso del internet (bancarios, académicos, entretenimiento) con el nivel académico y a su vez el estrato social. 

Otro parámetro interesante fueron las observaciones sobre las jefas de familia (proveedoras) que sostienen los hogares, que implica un posible crecimiento y genera un por de cuestiones ¿Las jefas familias llevan el sustento de un hogar incluyendo los gastos del conyugue?, si no fuera cierto, ¿son madres solteras que atienden la responsabilidad de un hogar? Éstas preguntas pueden avisar de movimientos sociales: (1) se normaliza que la mujer pueda sostener y mantener al conyugue y el hogar o (2) el número de madres solteras va en auge. Lo anterior no fue analizado en este trabajo pero existe la posibilidad de buscar la información en este data set.

Es importante resaltar que aunque nuestro objetivo era predecir con base en los servicios y comodidades de la vivienda en función del nivel académico; éstos terminan siendo no relevantes para la predicción. Entonces la pregunta es ¿Qué motiva a las nuevas familas a tener un mejor nivel académico?, evidentemente es mejorar las condiciones de vida y comodidades, pero con este set de datos no encontramos cual es la razón. Esto nos lleva a interpretar que los intereses de los nuevos profesionistas pueden enfocarse quizá en viajar o en experiencias, pero sólo es una posible interpretación que se puede resolver con estos datos.
...
En cuanto a la diferencia entre los conjuntos de datos de Nivel máximo de estudios en la vivienda y Nivel de estudios en el jefe de la vivienda, podemos obtener observaciones interesantes. Si el individuo posee una laptop ayudará a clasificar si el nivel máximo de estudios es primaria o secundaria, sabiendo que no usa internet o computadora recientemente. Un efecto parecido ocurre con la edad del jefe de la vivienda en la primera clasificación, el efecto es claro, no uso de la computadora e internet y una edad avanzada esta relacionado a bajo nivel educativo (primaria). Deja una puerta abierta para utilizar otros algoritmos e interpretar esos nuevos resultados.

## Conclusión

Este trabajo se realizó una selección de variables con la intención de resolver la pregunta ¿Existe una correlación de los servicios del hogar en función del nivel académico?, se realizó un análisis exploratorio de datos (EDA) y se encontraron datos como la tabla presentada que contiene información sumamente importante sobre como se encuentra actualmente el uso de las tecnologías de información en México. Uno de los datos más importantes es el nivel educativo de la persona encuestada, el cual se encuentra representado por la columna "NIVEL". A su vez, se caracterizó la tabla de datos con histogramas con la herramienta "altair" para discriminar la información entre mujeres y hombres. El EDA también incluyó mapas interactivos para una mejor comprensión de la información.

Todo el parrafo anterior condujo a la creación de un modelo de árboles de decisión que muestra que el uso de las tecnologías de la información como la computadora e internet, se encuentra estrechamente relacionado con el nivel de estudios de las personas. Es importante tener en cuenta este factor al hacer predicciones sobre el nivel educativo de un individuo. 

El acceso y la capacitación en el uso de estas herramientas se convierten en aspectos clave para mejorar la comprensión de las oportunidades educativas y laborales de las personas, especialmente en la actualidad donde la tecnología juega un papel fundamental en diversos aspectos de la vida.
